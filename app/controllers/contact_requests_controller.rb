class ContactRequestsController < ApplicationController
  ...
  def verify_google_recptcha(bamboo_secret_key,response)
    status = `curl "https://www.google.com/recaptcha/api/siteverify?secret=#{bamboo_secret_key}&response=#{response}"`
  ...
  def create
    ...
    status = verify_google_recptcha(bamboo_secret_key,params["g-recaptcha-response"])
