  ...
  describe '#create' do
    ...
    context 'when logged in' do
      before do
        ...
        expect(subject).to receive(:new_polymorphic_path).with([:curation_concerns, GenericWork]).and_return(main_app.new_hyrax_generic_work_path)
      end
      ...
      it 'requires authentication' do
        ...
        expect(response).to redirect_to(main_app.new_hyrax_generic_work_path)
      end
    end
  end
end
