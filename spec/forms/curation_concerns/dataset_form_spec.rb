...
RSpec.describe CurationConcerns::DatasetForm do
  ...
  describe "#primary_terms" do
    ...
    it { is_expected.to eq [:title, :creator, :college, :department, :alt_description, :required_software, :rights, :publisher] }
  end

  describe "#secondary_terms" do
    subject { form.secondary_terms }
    it do
      is_expected.to include(:alt_date_created, :alternate_title, :subject, :geo_subject,
